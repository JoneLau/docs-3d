...
- [Build and Publish](editor/publish/index.md)
  ...
  - [Publish to the Web](editor/publish/publish-web.md)
  - [Publish to Native](editor/publish/native-options.md)
    - [Setup Native Development](editor/publish/setup-native-development.md)
    - [Publish to Android](editor/publish/publish-android.md)
    - [Publish to iOS](editor/publish/publish-ios.md)
    - [Publish to Mac](editor/publish/publish-mac.md)
    - [Publish to Windows](editor/publish/publish-windows.md)
    - [Debugging JavaScript on Native Platforms](editor/publish/debug-jsb.md)
  - [Publish to Mini Games](editor/publish/publish-mini-game.md)
    ...
    - [Publish to Huawei Quick Games](editor/publish/publish-huawei-mini-game.md)
    ...
    - [Publish to Baidu Mini Games](editor/publish/publish-baidugame.md)
...
- [Scripting Guide and Event Mechanism](scripting/index.md)
   ...
   - [Builtin Events](engine/event/event-emit.md)
